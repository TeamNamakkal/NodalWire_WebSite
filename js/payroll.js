(function () {
  const css = `
    ...
    .pr-card::-webkit-scrollbar-track { background: rgba(255, 255, 255, 0.02); }
    .pr-card::-webkit-scrollbar-thumb { background: rgba(29, 120, 196, 0.3); border-radius: 3px; }
    .pr-card::-webkit-scrollbar-thumb:hover { background: rgba(29, 120, 196, 0.5); }
    .pr-card h2, .pr-card h3 { font-family: 'Lato', sans-serif; font-weight: 700; color: #eef4ff; letter-spacing: -0.02em; }
    .pr-card h2 { font-size: 24px; margin-bottom: 8px; }
    .pr-card h3 { font-size: 18px; margin-bottom: 16px; }
    .pr-card p { font-size: 14px; color: #7a9bbf; line-height: 1.6; }
    ...
    .pr-input, .pr-select { background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; padding: 10px 14px; font-family: 'Inter', sans-serif; font-size: 14px; color: #eef4ff; outline: none; transition: border-color 0.2s ease, box-shadow 0.2s ease; }
    .pr-input:focus, .pr-select:focus { border-color: #1D78C4; box-shadow: 0 0 0 3px rgba(29, 120, 196, 0.2); }
    .pr-select option { background: #07101f; color: #eef4ff; }
    ...
    .pr-btn-primary:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(29, 120, 196, 0.4); }
    .pr-btn-secondary { background: rgba(255, 255, 255, 0.06); border: 1px solid rgba(255, 255, 255, 0.12); color: #eef4ff; font-family: 'Lato', sans-serif; font-weight: 700; font-size: 14px; padding: 10px 20px; border-radius: 8px; cursor: pointer; transition: background 0.2s ease, transform 0.15s ease; }
    .pr-btn-secondary:hover { background: rgba(255, 255, 255, 0.1); transform: translateY(-1px); }
    .pr-btn-mini { padding: 6px 12px; font-size: 13px; border-radius: 6px; }
    .pr-header { display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid rgba(255, 255, 255, 0.08); padding-bottom: 16px; margin-bottom: 24px; }
    .pr-footer { display: flex; justify-content: flex-end; gap: 12px; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 16px; margin-top: 24px; }
    .pr-alert { background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.25); border-radius: 8px; padding: 12px; color: #fca5a5; font-size: 13px; margin-bottom: 16px; display: none; }
    .pr-table-container { overflow-x: auto; background: rgba(255, 255, 255, 0.01); border: 1px solid rgba(255, 255, 255, 0.06); border-radius: 10px; }
    .pr-table { width: 100%; border-collapse: collapse; font-size: 13px; text-align: left; }
    .pr-table th, .pr-table td { padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.06); }
    .pr-table th { background: rgba(255, 255, 255, 0.02); font-family: 'Lato', sans-serif; font-weight: 700; color: #1D78C4; text-transform: uppercase; font-size: 11px; letter-spacing: 0.05em; }
    .pr-table tbody tr:hover { background: rgba(255, 255, 255, 0.02); }
    .pr-form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
    .pr-preview-box { background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 10px; padding: 16px; margin-bottom: 20px; }
    .pr-preview-row { display: flex; justify-content: space-between; padding: 6px 0; font-size: 14px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); }
